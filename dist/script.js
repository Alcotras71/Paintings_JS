...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var animation = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'fadeInDown';
  ...
  bindModal('.fixed-gift', '.popup-gift', '.popup-gift .popup-close', 'jackInTheBox', true); // showModalByTime('.popup-consultation', 60000);
